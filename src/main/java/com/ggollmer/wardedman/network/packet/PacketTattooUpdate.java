...
public class PacketTattooUpdate extends PacketWardedManUser
{
	...
	public PacketTattooUpdate(UUID userId, int location, int id, int colour) {
		super(userId);
	...
	public void handle(MessageContext ctx) {
		...
		WardedMan.proxy.handleTattooUpdatePacket(userId, location, id, colour);
    }
	
	public static class Handler extends PacketWardedMan.Handler<PacketTattooUpdate> {}
}
