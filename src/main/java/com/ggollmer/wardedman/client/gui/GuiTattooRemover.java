...
public class GuiTattooRemover extends GuiScreen
{
	...
	public void initGui() {
        ...
        buttonList.add(submitButton = new GuiButtonModal(0, xOffset + 91, yOffset + 144, 176, 32, 176, 49, 39, 17, I18n.format(GuiConstants.TATTOO_REMOVER_SUBMIT), REMOVER_GUI_LOCATION));
        buttonList.add(cancelButton = new GuiButtonModal(1, xOffset + 132, yOffset + 144, 176, 32, 176, 49, 39, 17, I18n.format(GuiConstants.TATTOO_REMOVER_CANCEL), REMOVER_GUI_LOCATION));
	...
	private void submitRemovalRequest(int tattooLocation) {
		PacketHandler.INSTANCE.sendToServer(new PacketTattooRemove(this.player.getPersistentID(), tattooLocation));
	}
}
