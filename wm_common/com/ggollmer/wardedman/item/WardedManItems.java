...
public class WardedManItems
{
	...
	public static Item tattooViewer;
	...
	public static void init() {
		...
		tattooViewer = new ItemTattooViewer(ItemIds.TATTOO_VIEWER);
		...
		GameRegistry.registerItem(tattooViewer, ItemNames.TATTOO_VIEWER_NAME);
